    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="card shadow">
            <div id="elementBarcode">
                <div class="row">
                    <div class="col-4">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=1000x1000&data={{ $media->barcode }}"
                            alt="" width="100%">
                    </div>
                    <div class="col-8 mt-5">
                        <h1 id="barcodeName">{{ $media->no_media }}</h1> <br>
                        <h1 id="barcodeNameType">{{ $media->media_name }}</h1>
                    </div>
                </div>
            </div>
